package org.tap4j.plugin.simpleBuildStep;
...
import org.tap4j.plugin.TapPublisherShim;
import org.tap4j.plugin.TapResult;
import org.tap4j.plugin.TapTestResultAction;


public class TestSimpleBuildStepShim extends HudsonTestCase {
    ...
    public void testFailTestEmptyResultsAndOldReports() throws IOException, ServletException, InterruptedException, ExecutionException {
        ...
        TapPublisherShim publisher = new TapPublisherShim(
                "result.tap",
                true,
                true,
                true,
